...
<div class="mt-3">
    <ul class="nav nav-tabs mb-5">
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.inbox') }}">Inbox masuk 
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('admin.inbox-sudah-dibaca') }}">Sudah dibaca 
    ...
    <div class="card mt-3">
        <div class="media p-3">
            ...
            <div class="media-body pl-2">
                ...
                <form action="{{ route('admin.delete-inbox',$inbox->id) }}" method="post">
                    @csrf
                    @method('delete')
